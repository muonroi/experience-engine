...
# Experience Engine — Full Local Install Wizard (advanced)
#
# Legacy path: configures Qdrant, embed provider, brain LLM, collections, and
# installs experience-core.js locally. Most users should use setup.sh (thin
# client / Docker) or `npx @muonroi/experience-engine init` instead.
#
# Usage:
#   bash .experience/setup-full.sh          # interactive full wizard
#   bash .experience/setup.sh --full          # same (router delegates here)
#   bash .experience/setup-full.sh --local    # shortcut: local Qdrant + Ollama
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " Experience Engine — Full Local Install (advanced)"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
if [[ "$1" == "--help" || "$1" == "-h" ]]; then
  cat <<'HELP'
Usage: bash setup-full.sh [OPTIONS]

Advanced full-local install — configures Qdrant, embeddings, and brain LLM.
For thin-client / Docker installs use setup.sh or `npx @muonroi/experience-engine init`.
...
Reconfigure:
  Run setup-full.sh again and choose [2] Reconfigure.
HELP
  exit 0
fi
