...
const __srcdir = require('node:path').join(__dirname, '../../tools');
const test = require('node:test');
const assert = require('node:assert/strict');
const path = require('node:path');

const { loadFixture, runHarness } = require('../../tools/exp-holdout-harness.js');

const FIXTURE_DIR = path.join(__srcdir, '..', 'fixtures', 'holdout');
